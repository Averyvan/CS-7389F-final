...
labs_clus_comb_plain = create_cluster_of_nodes_segmented(server, project, 10, coords_west_zone[3].x - project.grid_unit * 5,
                                               ...
                                               lab_nameserver, router_template_id, 1.5)
...
labs_clus_comb_dtls = create_cluster_of_nodes_segmented(server, project, 5, coords_west_zone[3].x - project.grid_unit * 5,
...
labs_clus_hydr_plain = create_cluster_of_nodes_segmented(server, project, 10, coords_west_zone[3].x + project.grid_unit * 5, coords_west_zone[3].y + project.grid_unit * 2, 5,
                                               switch_template_id, hydraulic_system_template_id, switches_west_zone[3]["node_id"], 3,
                                               ipaddress.IPv4Interface("192.168.20.30/24"), "192.168.20.1", lab_nameserver, router_template_id, 1.5)
...
labs_clus_hydr_tls = create_cluster_of_nodes_segmented(server, project, 5, coords_west_zone[3].x + project.grid_unit * 5, coords_west_zone[3].y + project.grid_unit * 7, 5,
                                             switch_template_id, hydraulic_system_template_id, switches_west_zone[3]["node_id"], 4,
                                             ipaddress.IPv4Interface("192.168.20.40/24"), "192.168.20.1", lab_nameserver, router_template_id, 1.5)
...
steel_clus_cooler_plain = create_cluster_of_nodes_segmented(server, project, 10, coords_west_zone[2].x - project.grid_unit * 5, coords_west_zone[2].y + project.grid_unit * 2, 5,
                                                  switch_template_id, cooler_motor_template_id, switches_west_zone[2]["node_id"], 1,
                                                  ipaddress.IPv4Interface("192.168.19.10/24"), "192.168.19.1", lab_nameserver, router_template_id, 1.5)
...
steel_clus_pred_plain = create_cluster_of_nodes_segmented(server, project, 10, coords_west_zone[2].x + project.grid_unit * 5,
...
steel_clus_cooler_tls = create_cluster_of_nodes_segmented(server, project, 5, coords_west_zone[2].x - project.grid_unit * 5,
...
steel_clus_pred_tls = create_cluster_of_nodes_segmented(server, project, 5, coords_west_zone[2].x + project.grid_unit * 5,
                                              coords_west_zone[2].y + project.grid_unit * 7, 5,
                                              switch_template_id, predictive_maintenance_template_id,
...
neigh_clus_domotic_plain = create_cluster_of_nodes_segmented(server, project, 5, coords_west_zone[1].x - project.grid_unit * 5,
...
neigh_clus_ipcam = create_cluster_of_nodes_segmented(server, project, 2, coords_west_zone[1].x + project.grid_unit * 5,
...
neigh_clus_air_plain = create_cluster_of_nodes_segmented(server, project, 1, coords_west_zone[1].x + project.grid_unit * 5,
...
neigh_clus_city = create_cluster_of_nodes_segmented(server, project, 1, coords_west_zone[1].x + project.grid_unit * 5,
...
museum_clus_building_plain = create_cluster_of_nodes_segmented(server, project, 5, coords_west_zone[0].x - project.grid_unit * 5,
...
museum_clus_ipcam = create_cluster_of_nodes_segmented(server, project, 2, coords_west_zone[0].x + project.grid_unit * 5,
...
museum_clus_ipconsum = create_cluster_of_nodes_segmented(server, project, 2, coords_west_zone[0].x + project.grid_unit * 5,

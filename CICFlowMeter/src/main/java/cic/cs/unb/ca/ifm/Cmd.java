...
public class Cmd {
    ...
    private static void readPcapDir(File inputPath, String outPath, long flowTimeout, long activityTimeout) {
        ...
        for(int i=0;i<file_cnt;i++) {
            ...
            total += readPcapFile(file.getPath(),outPath,flowTimeout,activityTimeout);

        }
        System.out.println("Completed!");
        System.out.println(String.format("%d total valid packets processed", total));
    }

    //private static void readPcapFile(String inputFile, String outPath, long flowTimeout, long activityTimeout) {
    private static int readPcapFile(String inputFile, String outPath, long flowTimeout, long activityTimeout) {
